...
<div class = "painel">
    ...
    <div class = "registro">
        ...
        <table>
            ...
            <?php
                    while($user_data = $con->fetch_array()) {
                        echo "<tr>";
                        ...
                        echo "<td>
                        <a class='botao botao-editar' href='editar.php?usuario_id=$user_data[usuario_id]' title='Editar'>
                            ...
                            <td>
                            <a class='botao botao-deletar' href='deletar.php?usuario_id=$user_data[usuario_id]' title='Deletar' onclick='return confirm('Tem certeza que deseja excluir?')'>
            ...
            <?php while($dado = $con->fetch_array()) {
                echo "<tr>";
                echo "<td>".$dado['usuario_id']."</td>";
                echo "<td>".$dado['usuario']."</td>";
                echo "<td>".$dado['nome']."</td>";
                echo "<td>".$dado['senha']."</td>";
                echo "<td>".date('d/m/Y', strtotime($dado['data_cadastro']))."</td>"; 
                echo "<td>
                        <a class = 'botao botao-editar' href = 'editar.php' title = 'Editar'>
                            ...
                            <a class = 'botao botao-deletar' href = 'deletar.php?usuario_id=$dado[usuario_id]' title = 'Deletar'>
