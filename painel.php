        ...
        <table>
            ...
            <?php while($dado = $con->fetch_array()) { ?> 
                ...
                <td>
                        ...
                        <!--<a href="editar.php?codigo=<?php echo $dado['usu_codigo']; ?>">Editar</a> 
                        <a href="excluir.php?codigo=<?php echo $dado['usu_codigo']; ?>" onclick="return confirm('Tem certeza que deseja excluir?')">Excluir</a> 

                        <a href="painel;" onclick="return confirm('Tem certeza que deseja excluir?')">Excluir</a> 
                    -->
            <?php } ?> 
